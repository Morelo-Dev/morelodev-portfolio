...
export const projects: Project[] = [
  {
    id: 'jmfenix',
    title: 'JM Fénix — SaaS Tributario',
    description:
      'Plataforma SaaS para contadores y firmas contables en Colombia: gestión de clientes, empresas, obligaciones tributarias DIAN, pasarela de pagos Wompi, control de licencias, auditoría completa y notificaciones automáticas por email.',
    tags: [
      'React 19',
      'TypeScript',
      'Vite 7',
    ...
    liveUrl: 'https://jmfenix.morelodev.com',
    featured: true,
    accent: '#2563eb',
    details: {
      fullDescription:
        'JM Fénix es una plataforma SaaS full-stack diseñada para contadores y firmas contables en Colombia. Centraliza la gestión de clientes (personas naturales y jurídicas), empresas asociadas, obligaciones tributarias ante la DIAN, calendarios fiscales y control de acceso por roles granular. El backend en .NET 10 expone una API REST con autenticación Firebase, jobs recurrentes con Hangfire, caché Redis, pagos con Wompi y envío de emails transaccionales via Resend. El frontend en React 19 + Vite 7 sigue arquitectura feature-module estricta con design system propio (glassmorphism, tokens CSS HSL) y es instalable como PWA.',
      features: [
        'Gestión de clientes y empresas con perfil 360°',
        'Obligaciones tributarias y calendarios DIAN integrados',
        'Pasarela de pagos Wompi con webhooks y licenciamiento automático',
        'Control de roles y permisos granular por empresa',
        'Notificaciones automáticas por email (Resend)',
        'Jobs recurrentes con Hangfire (vencimientos, estados)',
        'Auditoría completa de acciones del sistema',
        'PWA instalable con soporte offline parcial',
        'API REST .NET 10 + PostgreSQL (Supabase) + Redis (Upstash)',
      ],
      year: 2025,
      status: 'in-progress',
      translations: {
